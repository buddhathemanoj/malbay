    ...
    return(
        <div className="loacation-bg-container">
            ...
            <div className="framing-container">
                ...
                <img src={sekinchan} alt="location" width={600} style={{borderRadius:"5px"}} />
            </div>

            <div className="sekinchan-container">
            <img src={mersing} alt="location" width={600} style={{borderRadius:"5px"}} />
            <div className="framing-container">
            ...
            <div className="framing-container">
                ...
                <img src={lumbur} alt="location" width={600} style={{borderRadius:"5px"}} />
            </div>

            <div className="sekinchan-container">
            <img src={highlands} alt="location" width={600} style={{borderRadius:"5px"}} />
            <div className="framing-container">
